...
B777DR_efis_baro_ref_capt_sel_dial_pos		= find_dataref("strato/B777/efis/baro_ref/capt/sel_dial_pos", "number")
...
B777DR_efis_baro_ref_fo_sel_dial_pos		= deferred_dataref("strato/B777/efis/baro_ref/fo/sel_dial_pos", "number")
B777DR_efis_baro_ref_capt_switch_pos		= deferred_dataref("strato/B777/efis/baro_std/capt/switch_pos", "number")
B777DR_efis_baro_ref_fo_switch_pos			= deferred_dataref("strato/B777/efis/baro_std/fo/switch_pos", "number")

-- Engine Type (crazytimitmtim)
B777DR_engineType                               = deferred_dataref("strato/B777/engines/type", "number")
...
function simconfig_values()
	return {
			...
			PLANE = {
						model = "777-400",  --777-400, 777-400ER, 777-400F
...
function set_loaded_configs()
	B777DR_modernAlarms = 1
	--Baro
	if simConfigData["data"].SIM.baro_indicator == "IN" then
		B777DR_efis_baro_ref_capt_sel_dial_pos = 0
	elseif simConfigData["data"].SIM.baro_indicator == "HPA" then
		B777DR_efis_baro_ref_capt_sel_dial_pos = 1
	end
	...
	if simConfigData["data"].SIM.capt_inbd == "EICAS" then
		B777DR_flt_inst_inbd_disp_capt_sel_dial_pos = 0
	...
	elseif simConfigData["data"].SIM.capt_inbd == "PFD" then
		B777DR_flt_inst_inbd_disp_capt_sel_dial_pos = 2
	end

	if simConfigData["data"].SIM.capt_lwr == "EICAS PRI" then
		B777DR_flt_inst_lwr_disp_capt_sel_dial_pos = 0
	...
	elseif simConfigData["data"].SIM.fo_lwr == "EICAS PRI" then
		B777DR_flt_inst_lwr_disp_fo_sel_dial_pos = 2
	end
