...
B777DR_CAS_warning_status       = deferred_dataref("strato/B777/CAS/warning_status", string.format("array[%s]", #B777_CASwarningMsg))
B777DR_CAS_caution_status       = deferred_dataref("strato/B777/CAS/caution_status", string.format("array[%s]", #B777_CAScautionMsg))
B777DR_CAS_advisory_status      = deferred_dataref("strato/B777/CAS/advisory_status", string.format("array[%s]", #B777_CASadvisoryMsg))
B777DR_CAS_memo_status          = deferred_dataref("strato/B777/CAS/memo_status", string.format("array[%s]", #B777_CASmemoMsg))
...
B777DR_warning_bell           	= deferred_dataref("strato/B777/warning/warning_bell")
B777DR_warning_siren           	= deferred_dataref("strato/B777/warning/warning_siren")
B777DR_warning_wailer           = deferred_dataref("strato/B777/warning/warning_wailer")
B777DR_master_caution           = find_dataref("strato/B777/warning/master_caution")
B777DR_master_caution_audio     = find_dataref("strato/B777/warning/master_caution_audio")
B777DR_fire_ovht_button_pos     = deferred_dataref("strato/B777/fire/fire_ovht/button_pos", "number")
...
debug_warning     = deferred_dataref("strato/B777/debug/warning", "number")
