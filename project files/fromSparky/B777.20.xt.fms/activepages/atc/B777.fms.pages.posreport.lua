...
"       POS REPORT        ",
"                         ",	               
string.format("%5s", B777DR_last_waypoint).."               "..string.sub(B777DR_waypoint_ata,1,4) .."Z",
"                         ",
"FL".. string.format("%03d",round(B777DR_altimter_ft_adjusted)) .."                 .".. string.format("%02d",round(simDR_mach_pilot*100)),
"                         ",
string.format("%5s",B777DR_ND_current_waypoint).."               ".. string.sub(B777DR_ND_waypoint_eta,1,4) .."Z" ,
"                         ",
string.format("%5s", B777DR_next_waypoint).."               ".. string.sub(B777DR_next_waypoint_eta,1,4) .."Z" ,
"                         ",
air_temp .."     ".. string.format("%s%"..(8-(string.len(B777DR_ND_Wind_Line))).."s",string.sub(B777DR_ND_Wind_Line.."KT",1,10),"") .."  "..grfuel,
"                         ",
"<SEND               SEND>" 
    }
end
