...
fmsPages["PASSENGERSOUNDCONFIG"].getPage=function(self,pgNo,fmsID)
	...
	if B777DR_SNDoptions[1] == 0 then
		lineA = "   /ON"
	else
		lineA = "OFF/  "
	end

	if B777DR_SNDoptions[2] == 0 then
		lineB = "   /ON"
	else
		lineB = "OFF/  "
	end

	if B777DR_SNDoptions[3] == 0 then
		lineC = "   /ON"
	else
		lineC = "OFF/  "
	end
...
fmsPages["GPWSSOUNDCONFIG"].getPage=function(self,pgNo,fmsID)
	...
	if pgNo == 1 then
		...
		for i = 1, 5 do
			if B777DR_SNDoptions_gpws[i] == 0 then
				line[i] = "ON/   "
			else
				line[i] = "  /OFF"
			end
...
fmsPages["MISCSOUNDCONFIG"].getPage=function(self,pgNo,fmsID)
	...
	if B777DR_SNDoptions[4] == 1 then
		lineA = "  /OFF"
	elseif B777DR_SNDoptions[4] == 0 then
		lineA = "ON/   "
	end

	if B777DR_SNDoptions[0] == 0 then
		lineB = "   /DEFLT/   "
	elseif B777DR_SNDoptions[0] == 1 then
		lineB = "   /     /NEW"
	elseif B777DR_SNDoptions[0] == 2 then
		lineB = "OLD/     /   "
	end

	if B777DR_SNDoptions[5] == 0 then
		lineC = "ON/   "
	elseif B777DR_SNDoptions[5] == 1 then
		lineC = "  /OFF"
	end
...
fmsPages["VOLUME"].getPage=function(self,pgNo,fmsID)
	...
	if pgNo == 1 then
		...
		lineA = B777DR_SNDoptions_volume[0]
		lineB = B777DR_SNDoptions_volume[1]
	...
	elseif pgNo == 2 then
		...
		lineA = B777DR_SNDoptions_volume[2]
		lineB = B777DR_SNDoptions_volume[3]
	...
	elseif pgNo == 3 then
		...
		lineA = B777DR_SNDoptions_volume[4]
		lineB = B777DR_SNDoptions_volume[5]
	...
	elseif pgNo == 4 then
		...
		lineA = B777DR_SNDoptions_volume[6]
		lineB = " "
