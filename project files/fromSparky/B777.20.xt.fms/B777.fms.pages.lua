...
dofile("activepages/B777.fms.pages.groundhandling.lua")
dofile("activepages/B777.fms.pages.maintsimconfig.lua")
dofile("activepages/B777.fms.pages.doors.lua")
...
--dofile("activepages/B777.fms.pages.pax-cargo.lua")
--dofile("activepages/B777.fms.pages.efisctl.lua")
--dofile("activepages/B777.fms.pages.eicasctl.lua")

dofile("activepages/B777.fms.pages.soundconfig.lua") CTTT]]
...
function updateCRZ()
  ...
  if alt~=nil then B777BR_cruiseAlt=alt end
  fmsModules:setData("crzalt",setVal)
end
function fmsFunctions.getdata(fmsO,value)
  local data=""
--[[  if value=="gpspos" then CRAZYTIMTIMTIM NOTE
...
function fmsFunctions.setdata(fmsO,value)
  ...
  elseif value=="irspos" then -- CRAZYTIMTIMTIM NOTE
...
function fmsFunctions.setDref(fmsO,value)
 ...
 --print(val)
  ...
  if value=="flapsRef" then B777DR_airspeed_flapsRef=val end
...
function fmsFunctions.setSoundOption(fmsO,value) -- sound options (crazytimtimtim + Matt726)
	...
	if value == "alarmsOption" then
		if B777DR_SNDoptions[0] ~= 2 then
			B777DR_SNDoptions[0] = B777DR_SNDoptions[0] + 1
		elseif B777DR_SNDoptions[0] == 2 then
			B777DR_SNDoptions[0] = 0
		end
		simConfigData["data"].SOUND.alarmsOption = B777DR_SNDoptions[0]
		pushSimConfig(simConfigData["data"]["values"])
	end

	if value == "seatBeltOption" then 
		B777DR_SNDoptions[1] = 1 - B777DR_SNDoptions[1] 
		simConfigData["data"].SOUND.seatBeltOption = B777DR_SNDoptions[1]
		pushSimConfig(simConfigData["data"]["values"])
		return 
	end
	if value == "paOption" then 
		B777DR_SNDoptions[2] = 1 - B777DR_SNDoptions[2] 
		simConfigData["data"].SOUND.paOption = B777DR_SNDoptions[2]
		pushSimConfig(simConfigData["data"]["values"])
		return 
	end
	if value == "musicOption" then 
		B777DR_SNDoptions[3] = 1 - B777DR_SNDoptions[3] 
		simConfigData["data"].SOUND.musicOption = B777DR_SNDoptions[3]
		pushSimConfig(simConfigData["data"]["values"])
		return 
	end
	if value == "PM_toggle" then 
		B777DR_SNDoptions[4] = 1 - B777DR_SNDoptions[4] 
		simConfigData["data"].SOUND.PM_toggle = B777DR_SNDoptions[4]
		pushSimConfig(simConfigData["data"]["values"])
		return 
	end
	if value == "V1Option" then 
		B777DR_SNDoptions[5] = 1 - B777DR_SNDoptions[5] 
		simConfigData["data"].SOUND.V1Option = B777DR_SNDoptions[5]
		pushSimConfig(simConfigData["data"]["values"])
		return 
	end

	if value == "GPWSminimums" then 
		B777DR_SNDoptions_gpws[1] = 1 - B777DR_SNDoptions_gpws[1] 
		simConfigData["data"].SOUND.GPWSminimums = B777DR_SNDoptions_gpws[1]
		pushSimConfig(simConfigData["data"]["values"])
		return 
	end
	if value == "GPWSapproachingMinimums" then 
		B777DR_SNDoptions_gpws[2] = 1 - B777DR_SNDoptions_gpws[2] 
		simConfigData["data"].SOUND.GPWSapproachingMinimums = B777DR_SNDoptions_gpws[2]
		pushSimConfig(simConfigData["data"]["values"])
		return 
	end
	if value == "GPWS2500" then 
		B777DR_SNDoptions_gpws[3] = 1 - B777DR_SNDoptions_gpws[3] 
		simConfigData["data"].SOUND.GPWS2500 = B777DR_SNDoptions_gpws[3]
		pushSimConfig(simConfigData["data"]["values"])
		return 
	end
	if value == "GPWS1000" then 
		B777DR_SNDoptions_gpws[4] = 1 - B777DR_SNDoptions_gpws[4] 
		simConfigData["data"].SOUND.GPWS1000 = B777DR_SNDoptions_gpws[4]
		pushSimConfig(simConfigData["data"]["values"])
		return 
	end
	if value == "GPWS500" then 
		B777DR_SNDoptions_gpws[5] = 1 - B777DR_SNDoptions_gpws[5] 
		simConfigData["data"].SOUND.GPWS500 = B777DR_SNDoptions_gpws[5]
		pushSimConfig(simConfigData["data"]["values"])
		return 
	end
	if value == "GPWS400" then 
		B777DR_SNDoptions_gpws[6] = 1 - B777DR_SNDoptions_gpws[6] 
		simConfigData["data"].SOUND.GPWS400 = B777DR_SNDoptions_gpws[6]
		pushSimConfig(simConfigData["data"]["values"])
		return 
	end
	if value == "GPWS300" then 
		B777DR_SNDoptions_gpws[7] = 1 - B777DR_SNDoptions_gpws[7] 
		simConfigData["data"].SOUND.GPWS300 = B777DR_SNDoptions_gpws[7]
		pushSimConfig(simConfigData["data"]["values"])
		return 
	end
	if value == "GPWS200" then
		 B777DR_SNDoptions_gpws[8] = 1 - B777DR_SNDoptions_gpws[8] 
		 simConfigData["data"].SOUND.GPWS200 = B777DR_SNDoptions_gpws[8]
		pushSimConfig(simConfigData["data"]["values"])
		 return 
	end
	if value == "GPWS100" then 
		B777DR_SNDoptions_gpws[9] = 1 - B777DR_SNDoptions_gpws[9] 
		simConfigData["data"].SOUND.GPWS100 = B777DR_SNDoptions_gpws[9]
		pushSimConfig(simConfigData["data"]["values"])
		return 
	end
	if value == "GPWS50" then 
		B777DR_SNDoptions_gpws[10] = 1 - B777DR_SNDoptions_gpws[10] 
		simConfigData["data"].SOUND.GPWS50 = B777DR_SNDoptions_gpws[10]
		pushSimConfig(simConfigData["data"]["values"])
		return 
	end
	if value == "GPWS40" then 
		B777DR_SNDoptions_gpws[11] = 1 - B777DR_SNDoptions_gpws[11] 
		simConfigData["data"].SOUND.GPWS40 = B777DR_SNDoptions_gpws[11]
		pushSimConfig(simConfigData["data"]["values"])
		return 
	end
	if value == "GPWS30" then 
		B777DR_SNDoptions_gpws[12] = 1 - B777DR_SNDoptions_gpws[12] 
		simConfigData["data"].SOUND.GPWS30 = B777DR_SNDoptions_gpws[12]
		pushSimConfig(simConfigData["data"]["values"])
		return 
	end
	if value == "GPWS20" then 
		B777DR_SNDoptions_gpws[13] = 1 - B777DR_SNDoptions_gpws[13] 
		simConfigData["data"].SOUND.GPWS20 = B777DR_SNDoptions_gpws[13]
		pushSimConfig(simConfigData["data"]["values"])
		return 
	end
	if value == "GPWS10" then 
		B777DR_SNDoptions_gpws[14] = 1 - B777DR_SNDoptions_gpws[14]
		simConfigData["data"].SOUND.GPWS10 = B777DR_SNDoptions_gpws[14]
		pushSimConfig(simConfigData["data"]["values"])
		return 
	end
	if value == "GPWS5" then 
		B777DR_SNDoptions_gpws[15] = 1 - B777DR_SNDoptions_gpws[15] 
		simConfigData["data"].SOUND.GPWS5 = B777DR_SNDoptions_gpws[15]
		pushSimConfig(simConfigData["data"]["values"])
		return 
	end
